...
TRAIN_SCRIPT = PROJECT_ROOT / "scripts" / "train_fusion_seq2seq.py"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the experimental fusion-to-text training in two stages.",
    )
    ...
    parser.add_argument("--stage_a_train_pt", type=str, default="out/meld_train.pt")
    parser.add_argument("--stage_a_val_pt", type=str, default="out/meld_dev.pt")
    parser.add_argument("--stage_a_out", type=str, default="out/fusion_seq2seq/meld_best.pt")
    parser.add_argument("--stage_a_epochs", type=int, default=5)
    parser.add_argument("--stage_a_bs", type=int, default=4)
    ...
    parser.add_argument("--stage_b_train_pt", type=str, default="out/fusion_dataset.pt")
    parser.add_argument("--stage_b_out", type=str, default="out/fusion_seq2seq/ko_best.pt")
    ...
    run_step("stage_a_meld_alignment", stage_a, args.dry_run)
    run_step("stage_b_korean_finetune", stage_b, args.dry_run)
